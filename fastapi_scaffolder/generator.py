...
class BackendGenerator:
    ...
    def generate_models(self):
        ...
        if not models:
            ...
            modules = {output: (self.input_name, models)}
        else:
...
#   timestamp: {timestamp}'''
        ...
        for path, filename_and_body in modules.items():
            filename, body = filename_and_body
            if path is None:
                file = None
            else:
            ...
            if body:
                ...
                sql_modeled = body\
                    .rstrip()\
                    .replace("from pydantic", "from sqlmodel")\
                    .replace("BaseModel", "SQLModel")
                print(sql_modeled, file=file)
